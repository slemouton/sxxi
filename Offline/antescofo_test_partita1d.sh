...
# ./antescofo-standalone-614 --nofharm 10 --dummysilences 1 --preventzigzag 1 --tout partita1b.tout -a $sf -s $sco
python3  /Users/lemouton/Projets/Python/PycharmProjects/antescofo-plot/ascoplot.py partita1d
