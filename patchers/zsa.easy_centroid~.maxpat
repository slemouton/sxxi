...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 275.0, 111.0, 375.0, 20.0 ],
					"text" : "prepend script replace pfft newex 0 0 200 12 pfft~ zsa.abs_centroid~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 45.0, 110.0, 200.0, 0.0 ],
					"text" : "pfft~ zsa.abs_centroid~ 1024 4",
					"varname" : "pfft"
				}
